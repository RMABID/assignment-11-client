...
const Footer = () => {
  return (
    <footer className="py-16 bg-secondary_primary text-primary dark:bg-gray-100 dark:text-gray-900">
      <div className="container px-6 mx-auto space-y-6 divide-y dark:divide-gray-600 md:space-y-12 divide-opacity-50">
        <div className="grid grid-cols-12">
          ...
          <div className="col-span-6 text-center md:text-left md:col-span-3">
            <p className="pb-1 text-lg uppercase font-medium">Category</p>
            <ul className="space-y-3 font-Garamond mt-6">
              <li className="transition-all duration-500 hover:translate-x-3 ease-linear">
                <Link>Features</Link>
              </li>
